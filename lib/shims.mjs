...
import {haveHighResTiming} from "./features.mjs";
import {isNode, isDeno, isQuickJS, isV8Shell} from "./engines.mjs";
 ...
 */
export const argv =
	isNode    ? self.process.argv.slice(2) :
	isDeno    ? self.Deno.args.slice(1) :
	isQuickJS ? self.scriptArgs.slice(1) :
